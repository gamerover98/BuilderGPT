#!/usr/bin/env bash
# Runs every automated check for BuilderGPT: typecheck plus the four test suites.
#
...
STEP_NAMES=(typecheck hello smoke sandbox services)
STEP_SCRIPTS=(typecheck smoke:hello smoke smoke:sandbox smoke:services)
STEP_RESULTS=()
